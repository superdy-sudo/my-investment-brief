...
**เป้าหมาย:** แปลผลจาก Layer 1–4 + Bull/Bear ข้างบนให้เป็น **สรุปแบบหัวข้อ** (ไม่ใช่บทพูด/สคริปต์) รูปแบบเดียวกับที่บันทึกใน `youtube-digests/longtoon-diary.md` ทุกประการ — ใช้อ่านเก็บเข้าคลังความรู้ ไม่ใช่บทพูดคนเดียว

**รูปแบบ (ก็อปสไตล์จาก digest ที่มีอยู่แล้ว):**
```
1. **[หัวข้อสั้นๆ ตัวหนา]:** [รายละเอียด 1-2 ประโยค พร้อมตัวเลข/หลักฐานอ้างอิง]
2. **[หัวข้อสั้นๆ ตัวหนา]:** [รายละเอียด]
3. **[หัวข้อสั้นๆ ตัวหนา]:** [รายละเอียด]
4. **[หัวข้อสั้นๆ ตัวหนา]:** [รายละเอียด]
```
- 4–5 ข้อ ต่อ 1 ตัว (เหมือนโครงสร้าง digest เดิม)
- แต่ละข้อ = หนึ่งประเด็นเด่นจาก Layer 1–4/Bull-Bear ข้างบน (เช่น ตัวเลข growth เด่น, ข้อกังวลเรื่อง valuation, moat, ความเสี่ยงหลัก) เขียนกระชับแบบ headline ไม่ใช่ประโยคเล่าเรื่อง
- ข้อสุดท้ายควรเป็นสรุปมุมมองต่อ **ตัวหุ้นเอง** (คุณภาพ/ความเสี่ยง standalone — ห้ามเอาเกณฑ์เฉพาะพอร์ตนี้ เช่น growth bar 30%/kill zone มาตัดสินว่าหุ้น "ดีหรือแย่" ดู `feedback-dont-overfilter-portfolio-rules` memory)

**ห้ามแต่งข้อมูลใหม่** — ใช้เฉพาะตัวเลข/ข้อเท็จจริงที่วิเคราะห์ไปแล้วใน Layer 1–4 และ Bull/Bear เท่านั้น สรุปนี้คือ "เรียบเรียงใหม่ให้กระชับแบบ digest" ไม่ใช่แหล่งข้อมูลใหม่
...
2. **[หัวข้อ]:** [รายละเอียด]
3. **[หัวข้อ]:** [รายละเอียด]
4. **[หัวข้อ]:** [รายละเอียด — ข้อสุดท้ายควรเป็นมุมมองต่อตัวหุ้นเอง แยกจากเกณฑ์พอร์ต]
```
