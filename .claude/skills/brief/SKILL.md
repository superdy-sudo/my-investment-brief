...
### 3.5 🎙️ สคริปต์เล่าสไตล์ "ลงทุน Diary" (2026-07-25) — ทำทุกครั้ง

**เป้าหมาย:** แปลผลจาก Layer 1–4 + Bull/Bear ข้างบนให้เป็น "บทพูดคนเดียว" อ่านเพลินเหมือนฟังคลิปช่อง ลงทุน Diary — สำหรับอ่านเท่านั้น ไม่ใช่เพื่อทำคลิปจริง

**โทน/สไตล์ (อ้างอิงจาก `youtube-digests/longtoon-diary.md`):**
- พูดคนเดียวแบบกันเอง ใช้ "ผม" ลงท้าย "นะครับ/เนาะ/อ่ะ" ปนมุกขำๆ ได้บ้าง
- เจอตัวเลขเด่นมี reaction ทันที (ตกใจ/ดีใจ/สงสัย) ไม่ใช่รายงานเฉยๆ
- เปิดประเด็นน่ากังวล/น่าสนใจทีละข้อ เหมือนเล่าเป็นฉากๆ
- จบด้วยความเห็นส่วนตัวชัดเจนว่า "จะซื้อไหม" พร้อมเหตุผล ไม่ใช่แค่สรุปข้อมูลซ้ำ

**โครงสร้าง (~400–600 คำ ภาษาไทย):**
1. เกริ่นสั้นๆ ว่าวันนี้จะพูดเรื่องอะไร (หุ้นตัวนี้ + เหตุผลที่มาบรีฟวันนี้)
2. ตัวเลขเด่นสุด (revenue/growth/valuation) + reaction ส่วนตัว
3. ประเด็นน่ากังวล/บวก 2–4 ข้อ (ดึงจาก Bull/Bear ที่วิเคราะห์ไปแล้วในขั้นตอนที่ 3) พูดทีละข้อ
4. สรุป: ให้ความเห็นต่อ **ตัวหุ้นเอง** ก่อน (คุณภาพ/ความเสี่ยงแบบ standalone — ห้ามเอาเกณฑ์เฉพาะพอร์ตนี้ เช่น growth bar 30%/kill zone มาตัดสินว่าหุ้น "ดีหรือแย่" ดู `feedback-dont-overfilter-portfolio-rules` memory) แล้วค่อยปิดท้ายอีก 1 บรรทัดแยกต่างหากว่าตรงกับสไตล์ aggressive-growth ของพอร์ตนี้ไหม

**ห้ามแต่งข้อมูลใหม่** — ใช้เฉพาะตัวเลข/ข้อเท็จจริงที่วิเคราะห์ไปแล้วใน Layer 1–4 และ Bull/Bear เท่านั้น สคริปต์นี้คือ "เล่าใหม่ให้มีชีวิตชีวา" ไม่ใช่แหล่งข้อมูลใหม่
...
━━ 🎙️ สคริปต์เล่าแบบ ลงทุน Diary ━━
[บทพูดคนเดียว ~400-600 คำ ตามสไตล์ในขั้นตอนที่ 3.5 — ไม่แต่งข้อมูลใหม่ ใช้เฉพาะสิ่งที่วิเคราะห์ไปแล้วข้างบน]
```
