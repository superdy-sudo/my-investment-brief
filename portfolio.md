...
> 🏆 **Jul 30, 2026 (/brief refresh)** — **BX** $129.40 (Blackstone Inc.) — Wide Moat (Scale Economies+Switching Costs) — Action **Buy** (⚠️ Second opinion: Bear ชนะเชิงจังหวะ — sister BDC fund BXSL ปรับเป็น Hold, non-accrual 3.1%, ต้องอัดฉีดสภาพคล่อง BCRED รอบสอง) — 🟢 Cheap (GF Value -37-38%, Morningstar -19%) — thesis ผิดถ้า BCRED redemption request เกิน 15% ติดต่อกัน 2 ไตรมาส — ดู `briefs/BX-2026-07-24.md`
>
> **META ถูกถอดออกจาก Top Pick** (2026-07-30) — /brief refresh หลัง Q2 earnings พบว่า growth ชะลอจาก +33%→+28% YoY (ต่ำกว่าเกณฑ์ ≥30%) + TAM ไม่ถึง 5x market cap → Layer 2 เหลือ 3/5 confirmed (ต่ำกว่าเกณฑ์ ≥4/5) → **Action = Avoid** ตามกฎพอร์ต แม้ Morningstar/GuruFocus ยังมองว่า Cheap (FV $820-850) — ดู `briefs/META-2026-07-30.md` รายละเอียดเต็ม
