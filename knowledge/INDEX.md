...
| GWRE | [2026-09-04] 🔴 Avoid (mechanical, style mismatch) — Q4 FY2026 beat ทุกตัวชี้วัด แต่ FY2027 guide ชะลอ (ARR ~18%, revenue ~16.4%) ต่ำกว่าเกณฑ์พอร์ต 30% มาก + TAM เหลือแค่ 1.06x-2.11x mkt cap (<5x) → Layer 2 3/5 มี 2 confirmed fail | ราคาร่วง -15.58% after-hours เหลือ $171.18 | **Kill Condition (ARR <15% YoY) ยังไม่ trigger** — ARR ยังโต 18-19%, kill buffer +98.6% ไม่ใช่ emergency | Switching Cost (Wide Moat ยืนยัน) | ❌ ต่ำกว่าเกณฑ์ (FY27 guide ~16.4%, deceleration) | [GWRE.md](GWRE.md) |
